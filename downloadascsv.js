(function () {
  ...
  angular.module('csvUtility', []).directive('downloadCsv', function () {
      return {
          restrict: 'A',
          link: function (scope, elem, attrs) {
              var _debugging, _log, _content, link, download, _ngProperty, _ngProperties, _excluded, excluded, _row;
              ...
              _ngProperty = function _ngProperty(prop, i) {
              ...
              _excluded = function _excluded (prop, i) {
              ...
              download = function download(_file, filename) {
                  ...
                  if (window.chrome !== void 0) {
                      ...
                      _log("using IE ");
                      // msMaxTouchPoints is the best way to check for Internet Explorer 11
              ...
              angular.element(elem).on('click', function onClickListenerDownloadAsCSV() {
                  var prop;
                  _content = [];
                  excluded = [];
                  _row = [];
                  ...
                  if (attrs.headers === void 0 || attrs.headers !== "none") {
                      ...
                      for (prop in scope[attrs.rows][0]) {
                  ...
                  for (var i in scope[attrs.rows]) {
                      ...
                      for (prop in scope[attrs.rows][i]) {
